...
No need to list all possible filters you can create &mdash; they can be any, but most popular are: Price, Sale price, Brand, Product Category, Tag, custom Taxonomy, Size, Color, Weight, Length, On sale status, In Stock status, Downloadable, Backordered, Featured product statuses, Product type, Shipping Class, Product Visibility, Featured image, Views count, Cooking time, Calories, Author — **any**.
